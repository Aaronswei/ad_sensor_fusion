                      ...
                      cv::Mat& trans_matrix)
{
    ...
    {
        cv::Point3d camera_points_temp;
        float point_in_cam_x = radar_points[i].x * rot_matrix.at<double>(0, 0) + radar_points[i].y * rot_matrix.at<double>(0, 1) + radar_points[i].z * rot_matrix.at<double>(0, 2) + trans_matrix.at<double>(0, 0);
        float point_in_cam_y = radar_points[i].x * rot_matrix.at<double>(1, 0) + radar_points[i].y * rot_matrix.at<double>(1, 1) + radar_points[i].z * rot_matrix.at<double>(1, 2) + trans_matrix.at<double>(1, 0);
        float point_in_cam_z = radar_points[i].x * rot_matrix.at<double>(2, 0) + radar_points[i].y * rot_matrix.at<double>(2, 1) + radar_points[i].z * rot_matrix.at<double>(2, 2) + trans_matrix.at<double>(2, 0);
        camera_points_temp.x = point_in_cam_x;
        camera_points_temp.y = point_in_cam_y;
        camera_points_temp.z = point_in_cam_z;
        camera_points.push_back(camera_points_temp);
    }
}
