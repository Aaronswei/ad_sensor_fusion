...
int main() {
    std::string calib_file_path = "/home/kavin/data/practice_2_4_camera_radar_data/front_left_right_camera.yml";
    std::string left_camera_path = "/home/kavin/data/practice_2_4_camera_radar_data/left_camera";
    std::string left_camera_label = "/home/kavin/data/practice_2_4_camera_radar_data/label_left_camera";
    std::string right_camera_path = "/home/kavin/data/practice_2_4_camera_radar_data/right_camera";
    std::string right_camera_label = "/home/kavin/data/practice_2_4_camera_radar_data/label_right_camera";
    std::string front_radar_path = "/home/kavin/data/practice_2_4_camera_radar_data/radar_front_center";
    ...
    //problem: please calculate yaw angle of radar to left camera by yourself
